...
const services = [
    {
        ...
        description: 'Desenvolvo sistemas web, sites instituicionais, blogs, portfólios, landing pages de alta conversão de forma responsiva e atrativa, além de apresentar uma estrutura de código sempre limpa e organizada.'
    },
    {
        icon: 'design_services',
        title: 'UI/UX Design',
        description: 'Produção de interfaces harmônicas, objetivas e principalmente interativas a fim de proporcionar a melhor experiência para o usuário'
    },
    {
        icon: 'mobile_friendly',
        title: 'Mobile First',
        description: 'Desenvolvimento de aplicações 100% responsivas, adaptativas para mobile seja ele tablet ou smartphone.'
    },
    {
        icon: 'database',
        title: 'Banco de Dados',
        description: 'Possuo conhecimentos em Banco de Dados e pratica com SQL, o qual pode ser aplicado em sistemas web através de sistemas de login, filtros de consulta, paginação de dados, exibição assíncrona e muito mais.'
    },
    {
        icon: 'network_intelligence_update',
        title: 'Integração com APIs',
        description: 'Experiência com manutenção e integração de APIs em Sistemas Web. Atualmente as APIs possuem um papel fundamental nos sistemas, pois elas são o "meio de campo" entre a Base de Dados e a Tela exibida ao cliente. '
    }
];
}),
